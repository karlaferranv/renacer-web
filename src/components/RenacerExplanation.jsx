      ...
      <div className={`section-inner explanation-inner reveal ${visible ? 'is-visible' : ''}`} ref={ref}>
        ...
        <div className="explanation-grid">
          <div className="explanation-item">
            <h3><span className="highlight">Tres fases, una transformación</span></h3>
          ...
          <div className="explanation-item">
            <h3><span className="highlight">15 a 30 minutos al día</span></h3>
          ...
          <div className="explanation-item">
            <h3><span className="highlight">Nunca caminas a ciegas</span></h3>
